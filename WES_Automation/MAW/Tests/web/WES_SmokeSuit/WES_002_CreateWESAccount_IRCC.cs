...
{
    [TestFixture]
    class WES_001_CreateWESAccount_IRCC : BaseWebTest
    {
        [TestCaseSource("Data")]
        ...
        {
            DataTable dt = ExcelDataUtils.getData(@"C:\Users\QM-Testing\Downloads\WES_Automation\MAW\TestData\Data.xlsx", 1);
