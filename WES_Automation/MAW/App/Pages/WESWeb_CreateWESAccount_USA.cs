...
{
    class WESWeb_CreateWESAccount_USA
    {
        ...
        By select_recip = By.XPath("//a[@href='#'][contains(.,'New Jersey Board of Pharmacy')]");
      ...
      */
        ...
        public void CreateAccount_ValidateEmail(DataRow row)
        {
            ...
            browserActions.ClickJSE(button_US, "US");
            ...
            //=====================Date of Birth=====================
            browserActions.selectByVisibleText(dd_db_Month, "January");
            browserActions.selectByVisibleText(dd_db_Day, "1");
            browserActions.selectByVisibleText(dd_db_Year, "1996");
       ...
       */
        public void CreateAccount_Education_Details(DataRow row)
        {
            ...
            browserActions.verifyText(LName, LName);
            browserActions.selectByVisibleText(year_awarded, "2017");
            browserActions.selectByVisibleText(start_year, "2013");
            browserActions.selectByVisibleText(end_year, "2017");
     ...
     */
        public void CreateAccount_Applicant_Recipients(DataRow row)
        {
            ...
            Thread.Sleep(4000);
            browserActions.selectByVisibleText(region, "New Jersey");
            browserActions.SendKeys(Zip, "08701");
    ...
    */
        public void CreateAccount_Institution_Recipients(DataRow row)
        {
            ...
            browserActions.sendKeyswithClick(search_Recipient, "New Jersey Board of Pharmacy");
